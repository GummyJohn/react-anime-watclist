...
const Home = () => {
  ...
  return (
    <>
      ...
      > 
        ...
        <div className='max-w-[1750px] mt-12 flex items-center px-5 '>
          ...
          <motion.div 
            ...
            animate={{x: 0}} 
            transition={{delay: .5}}  
            className='text-white w-6/12 border-2 rounded-2xl relative  mx-auto text-center flex flex-col justify-between h-[480px] phone_media_hidden'
          >
            ...
            <div className='relative z-20 pb-4 px-4 phone_media_hidden'>
              <div className='
      ...
      <div 
        className="
          max-w-[1750px] flex  my-6 m-auto text-white p-2 px-4
          phone_media_flex
        "
      >
        <motion.div 
        ...
        >
          ...
          <p 
            className='text-left h-[319px] overflow-auto bar phone_media_padding'>
        ...
        <motion.div 
          ...
          whileHover={{scale: 1.1, boxShadow: '0px 0px 20px orange'}}
          className="text-center border-2 p-4 w-full mx-5 rounded-3xl self-start phone_media_pm phone_media_margin"
        >
          ...
          <p className='text-left h-[319px] overflow-auto bar phone_media_padding'>
        ...
        <motion.div 
          ...
          whileHover={{scale: 1.1, boxShadow: '0px 0px 20px orange'}}
          className="text-center border-2 p-4 w-full mx-5 rounded-3xl self-start phone_media_pm "
        >
          <FontAwesomeIcon icon={faList} className='text-5xl my-4 text-orange-500'/>
